...
* [`have Default(())`](./std/tuples.mar)
* [`have Default((T, T))`](./std/tuples.mar)
* [`have Default((T, T, T))`](./std/tuples.mar)
* [`have Default((T, T, T, T))`](./std/tuples.mar)
* [`have Default((T, T, T, T, T))`](./std/tuples.mar)
* [`have Default((T, T, T, T, T, T))`](./std/tuples.mar)
* [`have Default((T, T, T, T, T, T, T))`](./std/tuples.mar)
* [`have Default((T, T, T, T, T, T, T, T))`](./std/tuples.mar)
